...
${OBJECTDIR}/src/findEsEf.o: src/findEsEf.f 
	...
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/findEsEf.o src/findEsEf.f

${OBJECTDIR}/src/superconductivity/fermi.o: src/superconductivity/fermi.f 
	${MKDIR} -p ${OBJECTDIR}/src/superconductivity
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/superconductivity/fermi.o src/superconductivity/fermi.f

${OBJECTDIR}/src/superconductivity/blockdat.o: src/superconductivity/blockdat.f 
	${MKDIR} -p ${OBJECTDIR}/src/superconductivity
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/superconductivity/blockdat.o src/superconductivity/blockdat.f

${OBJECTDIR}/src/superconductivity/esef.o: src/superconductivity/esef.f 
	${MKDIR} -p ${OBJECTDIR}/src/superconductivity
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/superconductivity/esef.o src/superconductivity/esef.f

${OBJECTDIR}/src/integ2d/twodq/xerrwv.o: src/integ2d/twodq/xerrwv.f 
	${MKDIR} -p ${OBJECTDIR}/src/integ2d/twodq
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/integ2d/twodq/xerrwv.o src/integ2d/twodq/xerrwv.f

${OBJECTDIR}/src/integ2d/twodq/greatr.o: src/integ2d/twodq/greatr.f 
	${MKDIR} -p ${OBJECTDIR}/src/integ2d/twodq
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/integ2d/twodq/greatr.o src/integ2d/twodq/greatr.f

${OBJECTDIR}/src/tcef.o: src/tcef.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/tcef.o src/tcef.f

${OBJECTDIR}/src/surf.o: src/surf.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/surf.o src/surf.f

${OBJECTDIR}/src/integ2d/integ2d.o: src/integ2d/integ2d.f 
	${MKDIR} -p ${OBJECTDIR}/src/integ2d
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/integ2d/integ2d.o src/integ2d/integ2d.f

${OBJECTDIR}/src/integ2d/twodq/twodq.o: src/integ2d/twodq/twodq.f 
	${MKDIR} -p ${OBJECTDIR}/src/integ2d/twodq
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/integ2d/twodq/twodq.o src/integ2d/twodq/twodq.f
...
${OBJECTDIR}/src/integ2d/triangulation/triangulation.o: src/integ2d/triangulation/triangulation.f 
	...
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/integ2d/triangulation/triangulation.o src/integ2d/triangulation/triangulation.f

${OBJECTDIR}/src/integ2d/twodq/basout.o: src/integ2d/twodq/basout.f 
	${MKDIR} -p ${OBJECTDIR}/src/integ2d/twodq
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/integ2d/twodq/basout.o src/integ2d/twodq/basout.f

${OBJECTDIR}/src/vanHove.o: src/vanHove.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/vanHove.o src/vanHove.f

${OBJECTDIR}/src/scdos.o: src/scdos.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/scdos.o src/scdos.f

${OBJECTDIR}/src/superconductivity/tcritical.o: src/superconductivity/tcritical.f 
	${MKDIR} -p ${OBJECTDIR}/src/superconductivity
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/superconductivity/tcritical.o src/superconductivity/tcritical.f

${OBJECTDIR}/src/integ2d/twodq/hpdel.o: src/integ2d/twodq/hpdel.f 
	${MKDIR} -p ${OBJECTDIR}/src/integ2d/twodq
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/integ2d/twodq/hpdel.o src/integ2d/twodq/hpdel.f
...
${OBJECTDIR}/src/superconductivity/spec.o: src/superconductivity/spec.f 
	${MKDIR} -p ${OBJECTDIR}/src/superconductivity
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/superconductivity/spec.o src/superconductivity/spec.f

${OBJECTDIR}/src/integ2d/twodq/hpins.o: src/integ2d/twodq/hpins.f 
	${MKDIR} -p ${OBJECTDIR}/src/integ2d/twodq
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/integ2d/twodq/hpins.o src/integ2d/twodq/hpins.f

${OBJECTDIR}/src/superconductivity/cec.o: src/superconductivity/cec.f 
	${MKDIR} -p ${OBJECTDIR}/src/superconductivity
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/superconductivity/cec.o src/superconductivity/cec.f

${OBJECTDIR}/src/integ2d/triangulation/setriang.o: src/integ2d/triangulation/setriang.f 
	${MKDIR} -p ${OBJECTDIR}/src/integ2d/triangulation
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/integ2d/triangulation/setriang.o src/integ2d/triangulation/setriang.f
